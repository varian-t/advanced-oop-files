...
![create-dialog](./ExamPrep/assets/create-dialog.png)
...
![hello](./ExamPrep/assets/hello.png)
...
![Check facade](./ExamPrep/assets/check.png)
...
![LaundroMat Diagram](./ExamPrep/assets/LaundroMat.png)
...
`ILaundryMachine.cs` (provided code) defines the methods:
...
![gui1](./ExamPrep/assets/gui1.png)
> Program 3 selected on machine 0.

![gui2](./ExamPrep/assets/gui2.png)
> 45 minutes of drying selected on machine 2.

![gui3](./ExamPrep/assets/gui3.png)
